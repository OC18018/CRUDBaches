 ...
 */
package occ.ues.edu.sv.crudbaches.entity;
 ...
 */
@Entity
@Table(name = "objeto_estado", catalog = "baches", schema = "public")
@NamedQueries({
...
public class ObjetoEstado implements Serializable {
    ...
    public String toString() {
        return "occ.ues.edu.sv.crudbaches.ObjetoEstado[ idObjetoEstado=" + idObjetoEstado + " ]";
    }
